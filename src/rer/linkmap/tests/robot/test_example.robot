...
#
#  $ bin/test -s rer.linkmap -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src rer.linkmap.testing.RER_LINKMAP_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/rer/linkmap/tests/robot/test_example.robot
#
